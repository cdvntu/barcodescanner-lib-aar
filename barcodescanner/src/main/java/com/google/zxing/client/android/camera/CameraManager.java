...
*/
      double width = screenResolution.x * 0.9;
      double height = screenResolution.y * 0.9;
      
      double leftOffset = (screenResolution.x - width) / 2;
      double topOffset = (screenResolution.y - height) / 2;
      framingRect = new Rect((int)leftOffset, (int)topOffset, (int)(leftOffset + width), (int)(topOffset + height));
